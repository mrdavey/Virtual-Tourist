...
class FlickrClient: NSObject {
    ...
    func getImagesFromFlickrBySearch(latitude: Double, longitude: Double, completionHandler: (result: AnyObject?, error: String?) -> Void) {
        let methodArguments = [
            ...
            "page": FlickrClient.Constants.PAGE,
